...
import { URLSearchParamsImpl } from '../src/URLSearchParamsImpl'
import { URLImpl } from '../src/URLImpl'

describe('URLSearchParamsImpl', () => {

  test('constructor', () => {
    let search: URLSearchParams
    search = new URLSearchParamsImpl("key1=value1&key2=value2")
    expect(search.toString()).toBe("key1=value1&key2=value2")
    search = new URLSearchParamsImpl([["key1", "value1"], ["key2", "value2"]])
    expect(search.toString()).toBe("key1=value1&key2=value2")
    search = new URLSearchParamsImpl({ key1: "value1", key2: "value2" })
    expect(search.toString()).toBe("key1=value1&key2=value2")
    search = new URLSearchParamsImpl()
    expect(search.toString()).toBe("")

    expect(() => new URLSearchParamsImpl([["key1", "value1", "invalid"]])).toThrow()
  })

  test('_updateSteps()', () => {
    const url = new URLImpl("https://example.org?key1=value1&key2=value2")
  ...
  test('append()', () => {
    const search = new URLSearchParamsImpl("key1=value1&key2=value2")
    search.append("key3", "value3")
  ...
  test('getAll()', () => {
    const search = new URLSearchParamsImpl("key1=value1&key2=value2&key1=value3")
  ...
  test('sort()', () => {
    const search = new URLSearchParamsImpl("key1=value5&key3=value3&key2=value2&key1=value1&key3=value4")
    search.sort()
  ...
  test('iterator()', () => {
    ...
    const search = new URLSearchParamsImpl("key1=value1&key2=value2&key3=value3")
